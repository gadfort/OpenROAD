# test for macros with non blocking rings
source "helpers.tcl"
...
add_pdn_stripe -layer metal5 -width 0.48 -spacing 4.0 -pitch 20.0 -offset 2.0
add_pdn_stripe -layer metal6 -width 0.48 -spacing 4.0 -pitch 20.0 -offset 2.0
...
add_pdn_ring -grid "sram1" -layers {metal5 metal6} -widths 2.0 -spacings 2.0 -core_offsets 2.0 -non_blocking
...
set def_file [make_result_file macros_with_rings.def]
write_def $def_file
diff_files macros_with_rings.defok $def_file
